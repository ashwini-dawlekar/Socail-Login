...
class Addbook extends React.Component {
    ...
    responseGoogle (googleUser) {
        ...
        // console.log('Name: ' + profile.getGivenName(profile.getId()));
    ...
    render() {
        return (
            <div className="hold-transition skin-blue sidebar-mini">
                ...
                <meta name="google-signin-client_id" content="691857502844-em6us5o49hrobl4kk104h4kadpsl8s0a.apps.googleusercontent.com"/>
                                ...
                                <div className="col-xs-12">
                                    <div className="box">
                                        ...
                                        <div className="box-info no-padding text-center">
                                            ...
                                            <div>
                                                <GoogleLogin socialId="691857502844-em6us5o49hrobl4kk104h4kadpsl8s0a.apps.googleusercontent.com"
                                                ...
                                                <FacebookLogin socialId="344291379313825"
                                                               language="en_US"
